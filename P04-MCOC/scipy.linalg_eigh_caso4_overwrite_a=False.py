...
fid1= open(f"scipy.linalg_eigh_driver=evr_overwrite=false_double_caso4.txt","w")
fid2= open(f"scipy.linalg_eigh_driver=evr_overwrite=false_float32_caso4.txt","w")
